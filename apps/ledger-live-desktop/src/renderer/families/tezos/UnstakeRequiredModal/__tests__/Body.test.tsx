...
describe("UnstakeRequiredModal/Body", () => {
  ...
  it("renders changeBaker title and description", () => {
    ...
    expect(
      screen.getByText(/Unstake your entire funds before delegating to a new baker/i),
    ).toBeInTheDocument();
  });
  ...
  it("renders endDelegation title and description", () => {
    ...
    expect(
      screen.getByText(/Unstake your entire funds before ending the delegation/i),
    ).toBeInTheDocument();
  });
