...
const buildSendTokenTransaction = async ({
  ...
  const sortedOtherUtxos = otherUtxos.toSorted(sortByAdaDesc);
...
const buildSendAdaTransaction = async ({
  ...
  const sortedUtxos = [
    ...pureAdaUtxos.toSorted(sortByAdaDesc),
    ...tokenBearingUtxos.toSorted(sortByAdaDesc),
  ];
...
const buildDelegateTransaction = async ({
  ...
  const sortedUtxos = cardanoResources.utxos.toSorted(sortByAdaDesc);
